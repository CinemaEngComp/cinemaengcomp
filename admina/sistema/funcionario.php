            ...
            <div class="col-lg-12">
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5>Grid de Funcionarios<small class="m-l-sm">Gerencie seus funcionarios</small></h5>
                    </div>
...
//      mygrid.imgURL = "/php/lib/javascript/dhtmlx/dhtmlxSuite_2008Rel3_pro_81009/dhtmlxGrid/codebase/imgs/icons_greenfolders/";
        ...
        mygrid.setHeader("ID,Nome, CPF, Nascimento, Sexo, Endereco, Numero, Bairro, Cidade, UF, CEP, Email, Senha, Confirmacao ");
        mygrid.setInitWidths("50,100,100,80,50,150,60,80,80,50,50,80,80,80")
        mygrid.setColAlign("left,left")
        mygrid.setColTypes("ro,edtxt,edtxt,edtxt,edtxt,edtxt,edtxt,edtxt,edtxt,coro,edtxt,edtxt,edtxt,edtxt");
...
//      mygrid.enableSmartXMLParsing(true);
        ...
        mygrid.loadXML("funcionario_get.php");
        
        
        myDataProcessor = new dataProcessor("funcionario_save.php"); 
        ...
        myDataProcessor.setVerificator(12,not_empty_senha);
        myDataProcessor.setVerificator(13,not_empty_senha);

        comboconta5=mygrid.getCombo(9);
        comboconta5.save();
        comboconta5.put('AC','AC');
        comboconta5.put('AL','AL');
        comboconta5.put('AP','AP');
        comboconta5.put('AM','AM');
        comboconta5.put('BA','BA');
        comboconta5.put('CE','CE');
        comboconta5.put('DF','DF');
        comboconta5.put('ES','ES');
        comboconta5.put('GO','GO');
        comboconta5.put('MA','MA');
        comboconta5.put('MG','MG');
        comboconta5.put('MS','MS');
        comboconta5.put('MT','MT');
        comboconta5.put('PA','PA');
        comboconta5.put('PB','PB');
        comboconta5.put('PR','PR');
        comboconta5.put('PE','PE');
        comboconta5.put('PI','PI');
        comboconta5.put('RJ','RJ');
        comboconta5.put('RG','RG');
        comboconta5.put('RN','RN');
        comboconta5.put('RO','RO');
        comboconta5.put('RR','RR');
        comboconta5.put('RS','RS');
        comboconta5.put('SC','SC');
        comboconta5.put('SE','SE');
        comboconta5.put('SP','SP');
        comboconta5.put('TO','TO');
...
//  mygrid.addRow(123,"text1,text2",1);
    if (null==mygrid.getSelectedId()) {
        mygrid.addRow('NOVO',['NOVO','Novo Funcionario']);
    } else {
        mygrid.addRowAfter((new Date()).valueOf(),['NOVO','Novo Funcionario'],mygrid.getSelectedId());
    }
}
