...
public class Cartaz extends Activity {
    ...
    private class DownloadJSON extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            mProgressDialog = new ProgressDialog(Cartaz.this);
        ...
        protected Void doInBackground(Void... params) {
            ...
            jsonobject = JSONfunctions
                    .getJSONfromURL("http://cinemaengcomp.nucci.com.br/cinemaengcomp/PHP/busca_filmes_cartaz.php");

            try {
                // Passando nome do array do json
                jsonarray = jsonobject.getJSONArray("filmes_cartaz");
        ...
        protected void onPostExecute(Void args) {
            if(arraylist.isEmpty()){
                Toast.makeText(getApplicationContext(), "Não existe nenhum filme em cartaz.", Toast.LENGTH_LONG).show();
                Intent telainicio = new Intent(Cartaz.this, MenuCliente.class);
                ...
                // Passando os resultados para a classe ListViewAdapter
                adapter = new ListViewAdapter(Cartaz.this, arraylist);
