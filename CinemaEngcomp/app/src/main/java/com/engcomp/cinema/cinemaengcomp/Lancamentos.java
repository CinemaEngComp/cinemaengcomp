...
public class Lancamentos extends Activity {
    ...
    private class DownloadJSON extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            mProgressDialog = new ProgressDialog(Lancamentos.this);
        ...
        protected Void doInBackground(Void... params) {
            ...
            jsonobject = JSONfunctions
                    .getJSONfromURL("http://cinemaengcomp.nucci.com.br/cinemaengcomp/PHP/busca_filmes_lancamento.php");

            try {

                // Passando nome do array do json
                jsonarray = jsonobject.getJSONArray("filmes_lancamentos");
        ...
        protected void onPostExecute(Void args) {
            if(arraylist.isEmpty()){
                Toast.makeText(getApplicationContext(), "Não existe nenhum lançamento.", Toast.LENGTH_LONG).show();
                Intent telainicio = new Intent(Lancamentos.this, MenuCliente.class);
                ...
                // Passando os resultados para a classe ListViewAdapter3
                adapter = new ListViewAdapter3(Lancamentos.this, arraylist);
