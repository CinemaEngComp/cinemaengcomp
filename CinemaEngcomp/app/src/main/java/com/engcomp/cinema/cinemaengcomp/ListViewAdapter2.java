...
class ListViewAdapter2 extends BaseAdapter {
    ...
    ListViewAdapter2(Context context,
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        nome_filme.setText(resultp.get(Estreias.NOME_FILME));
        genero_filme.setText(resultp.get(Estreias.GENERO_FILME));
        duracao_filme.setText(resultp.get(Estreias.DURACAO_FILME));
        classificacao_filme.setText(resultp.get(Estreias.CLASSIFICACA0_FILME));
        sinopse_filme.setText(resultp.get(Estreias.SINOPSE_FILME));

        // Capture position and set results to the ImageView
        // Passando url da imagem para a classe ImageLoader.class
        imageLoader.DisplayImage(resultp.get(Estreias.CAMINHO), caminho);
        ...
        itemView1.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                intent.putExtra("nome_filme", resultp.get(Estreias.NOME_FILME));
                intent.putExtra("genero_filme", resultp.get(Estreias.GENERO_FILME));
                intent.putExtra("duracao_filme", resultp.get(Estreias.DURACAO_FILME));
                intent.putExtra("classificacao_filme", resultp.get(Estreias.CLASSIFICACA0_FILME));
                intent.putExtra("sinopse_filme", resultp.get(Estreias.SINOPSE_FILME));
                intent.putExtra("email", resultp.get("email"));
                intent.putExtra("caminho", resultp.get(Estreias.CAMINHO));
                intent.putExtra("codigo_filme", resultp.get(Estreias.CODIGO_FILME));
