...
X = (document.compatMode!="BackCompat"?"X":"");
   if (!this.fullview) {
	   ...
	   if ((document.all)&&((this.container.style.position=="absolute")))
		   html +="<iframe src='"+(window.dhx_globalImgPath||"")+"blank.html' frameBorder='0' style='position:absolute; top:0px; left:0px; width:252px;  height:"+(this._cc?300:244)+"px; z-index:-1;'></iframe>";
	   ...
	   if (this._cc){
		html +=	"<tr><td colspan='6'><input tabindex='7' class='cs_CustomColorAdd_Mini' csid='cs_CustomColorAdd' type='button' value='"+this.language.btnAddColor+"' onClick='this.addCustomColor();'></td></tr>";			     
	   ...
	   if (this._cc){
		...
		html +=	"</td><td></td><td colspan='4' valign='top'><input tabindex='7' class='cs_CustomColorAdd' csid='cs_CustomColorAdd' type='button' value='"+this.language.btnAddColor+"' onClick='this.addCustomColor();'></td></tr>";
	   }
	   html +=	"</table>";   
	   html += "</td></tr>";
	   html += "</table>";
