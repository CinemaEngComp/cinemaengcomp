...
this.err_form="Por favor digite valores para os campos:\n\n";
this.err_select="Por vafor, selecione um valor válido  \"%FIELDNAME%\"";
this.err_enter="Por favor, entre com um valor válido \"%FIELDNAME%\"";
};
