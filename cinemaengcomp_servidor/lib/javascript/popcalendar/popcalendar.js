...
//	email  : pinotoy@yahoo.com
	...
	var imgDir = '../lib/javascript/popcalendar/';		// directory for images ... e.g. var imgDir="/img/" - Alterado por Jehad 27/06/2006
//	var dayName = '';

	var gotoString = {
		en : 'Go To Current Month',
		pt : 'Ir para mês corrente',
		es : 'Ir al Mes Actual',
	...
	var scrollLeftMessage = {
		...
		pt : 'Clique para mês anterior. Deixe o mouse pressionado para navegar por vários meses.',
	...
	var scrollRightMessage = {
		...
		pt : 'Clique para mês posterior. Deixe o mouse pressionado para navegar por vários meses.',
	...
	var selectDateMessage = {		// do not replace [date], it will be replaced by date.
		...
		pt : 'Selecionar [date] como data.',
		es : 'Seleccione [date] como fecha',
		de : 'Wähle [date] als Datum.'
	};
	var	monthName = {
		en : new Array('January','February','March','April','May','June','July','August','September','October','November','December'),
		pt : new Array("Janeiro", "Fevereiro", "Março", "Abril", "Maio", "Junho", "Julho", "Agosto", "Setembro", "Outubro", "Novembro", "Dezembro"),
	...
	*/
	...
	function init() {
		...
		{
			if (!ie) yearNow += 1900;
			if ('Konqueror'==navigator.appName)yearNow += 1900;
