...
var gsOutOfRange="Desculpe, você não pode ir além da faixa designada!";	// out-of-date-range error message. If set to "", no alerts will popup on such error.
...
var gcWorkday="gray";	// Workday font color
var gcSat="gray";	// Saturday font color
var gcSatBG=null;	// Saturday background color
var gcSun="gray";	// Sunday font color
...
var gcBGSelected="gray";	// the background color for the selected date
var guSelectedBGImg="";	// url of image as background of the selected date
var giMarkSelected=1+2+4+8;	// Effects for selected date - 0: nothing; 1: set background color with gcBGSelected; 2: draw a box with gcBGSelected; 4: bold the font; 8: set font color with gcFGSelected; 16: set background image with guSelectedBGImg; - they can be added up to create mixed effects.
