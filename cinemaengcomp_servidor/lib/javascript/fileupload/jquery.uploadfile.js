...
(function ($) {
    ...
    $.fn.uploadFile = function (options) {
        ...
        var s = $.extend({
            ...
            dragDropStr: "<span><b>Arraste e solte</b></span>",
            abortStr: "Abort",
            cancelStr: "Cancela",
            deletelStr: "Deletar",
            doneStr: "Ok",
            ...
            uploadErrorStr: "Não é permitido"
        }, options);
        ...
        function serializeAndUploadFiles(s, obj, files) {
            for (var i = 0; i < files.length; i++) {
                ...
                var form = $("<form style='display:block; position:absolute;left: 0px;' class='" + obj.formGroup + "' method='" + s.method + "' action='" + s.url + "' enctype='" + s.enctype + "'></form>");
                form.appendTo('body');
                var fileArray = [];
