            ...
            <div class="col-lg-12">
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5>Grid de Sala<small class="m-l-sm">Gerencie suas salas</small></h5>
                    </div>
...
//      mygrid.imgURL = "/php/lib/javascript/dhtmlx/dhtmlxSuite_2008Rel3_pro_81009/dhtmlxGrid/codebase/imgs/icons_greenfolders/";
        ...
        mygrid.setHeader("ID Sala,Tipo");
        mygrid.setInitWidths("100,100")
        mygrid.setColAlign("left,left")
        mygrid.setColTypes("ro,coro");
...
//      mygrid.enableSmartXMLParsing(true);
        ...
        mygrid.loadXML("sala_get.php");
        
        
        myDataProcessor = new dataProcessor("sala_save.php"); 
        ...
        comboconta5=mygrid.getCombo(1);
        comboconta5.save();
        comboconta5.put('Normal','Normal');
        comboconta5.put('3D','3D');
        comboconta5.put('4D','4D');
        comboconta5.put('IMAX','IMAX');
...
//  mygrid.addRow(123,"text1,text2",1);
    if (null==mygrid.getSelectedId()) {
        mygrid.addRow('NOVO',['NOVO','1-Normal']);
    } else {
        mygrid.addRowAfter((new Date()).valueOf(),['NOVO','1-Normal'],mygrid.getSelectedId());
    }
}
